...
';
	...
	public function store_js_queued_elements() {
		global $wp_scripts;
		...
		update_option('lcso_queued_scripts', $queued_js);
	}
    
	public function store_css_queued_elements() {
		global $wp_styles;	
		...
		update_option('lcso_queued_styles', $queued_css);
	}
